  ...
  <div id="main">
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="getin.php">Login</a></li>
...
<a href="http://24timezones.com/world_directory/addis_ababa_local_time.php" target="_blank" title=" " style="text-decoration: none">
			...
			<p><li class="current"><a href="mission.php" class="style15">Our Mission </a></li><li class="current"><a href="vission.php" class="style15">Our Vission </a></li> 
			<div id="menubar1">
			  <table width="200" height="248">
	...
	<div>
	  ...
	  <div id="content1">
        <div class="content_item">
		  <p>&nbsp;</p><h2>Mission</h2>
		  <p>Insure peace,justice stablity,democracy and good governance.</p>
		  <p>Establish fast,flexible and balanced judgment which is free from corruption.</p>
	      </div>&nbsp;</p>
		  <p>&nbsp;</p>
        </div>
	  </div>
	  <ul id="menu">
        ...
        <li class="style9  style18">
          <h2 class="style19">Copyright©2022 Court Management System </h2>
        </li>
      </ul>
	  <!--close sidebar_container-->
    </div>
