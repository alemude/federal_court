...
if($A!=$caseID){
 echo '<script type="text/javascript">alert(" You entered unknown case ID!!");window.location=\'evidence.php\';</script>';	
}
else if($date>date('Y/m/d')){
 echo '<script type="text/javascript">alert("Wrong date!!");window.location=\'evidence.php\';</script>';	
}
else if($caseID==$A){
...
if ($db->query($sql) === TRUE) {
 echo '<script type="text/javascript">alert("Success");window.location=\'evidence.php\';</script>';
		}}
		else {
