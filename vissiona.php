...
.style15 {color: #003366; font-size: small; }
-->
  </style>
</head>
...
<body>
  <div id="main">
	<div id="menubar">
      <ul id="menu">
        <li ><a href="abouta.php">ስለፍርድ ቤቱ</a></li>
        <li ><a href="cntcta.php">እኛን ለማግኘት </a></li>
        <li><a href="getina.php">ግባ </a></li>
             ...
             <ol>
          <a href="index.php"><li>English</li></a>
	      <a href="indexa.php"><li>አማርኛ</li></a>
             </ol>
             </div></p></a></li>
      </ul>
    </div><!--close menubar-->	
...
<script src="http://24timezones.com/timescript/maindata.jsa.php?city=815322" language="javascript"></script>
...
<a href="http://24timezones.com/world_directory/addis_ababa_local_timea.php" target="_blank" title=" " style="text-decoration: none">
</a></td></tr></table>
            
			<p><li><a href="missiona.php" class="style15">ተልዕኮ </a></li>
			<li class="current"><a href="vissiona.php" class="style15">ራዕይ </a></li>
			</p>
			<div id="menubar1">
	
	
	  
          <table width="212" height="275">
	...
	<div>
	  ...
	  <div id="content1">
        <div class="content_item">
		  <p>&nbsp;</p><h2>ራዕይ</h2>
		  <p>በወረዳችን  እስከ 2020 ዓ/ም ድረስ  የህግ  የበላይነት ተረጋግጦ ፍትህ ሰፍኖ  የህዝቦች የሙያ  ክብር ነፃነት ሰብአዊነትና ዴሞክራሲያዊ  መብታቸውን  በአስተማማኝ   ደረጃ  ላይ ደርሶ ማየት ።</p>
	</div>&nbsp;</p>
		  <p>&nbsp;</p>
        </div>
	  </div>
	  <ul id="menu">
        ...
        <li class="style9  style18">
          <h2 class="style19">Copyright©2022 የፍርድ ቤት አያያዝ ሲስተም </h2>
        </li>
      </ul>
	  <!--close sidebar_container-->
    </div>
