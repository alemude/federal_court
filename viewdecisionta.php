<html>
<div style="font-size:35px;color:green;font-weight:bold;text-align:center">ከታች ያሉት ፋይሎች የተመዘገቡ የውሳኔ መረጃ ናቸው</div>
<head>
...
<body>
<form action="viewdecisionta.php" method="post">
<h2>መፈለጊያውን ያስገቡ</h2>
