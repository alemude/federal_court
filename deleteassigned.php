...
<form action="deleteassigned.php" method="post" style="box-shadow:rgba(0,0,0,1) 0px 0px 10px;width:40%;height:60%; background-color:Silver;border-radius:10px;color:black;font-weight:bold">
<p style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%;height:60%; background-color:yellow;border-radius:5px;color:black;font-size:30px;font-weight:bold">Fill the bellow to delete assigned case</p>
