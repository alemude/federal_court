...
if (isset($_POST['login_user'])) {
    ...
    if (empty($user_name)) {
        array_push($errors, "የተጠቃሚ ስም ግድ ነው");
    }
    if (empty($password)) {
        array_push($errors, "የምስጢር ቃል የግድ ነው");
    }
...
$UN=$_POST['user_name'];	
			...
			header('location:customer_ha.php');
			}
			}
         }
...
$UN=$_POST['user_name'];	
			...
			header('location:advocator_ha.php');
			}
	...
	$password = md5($password);
        ...
        if (mysqli_num_rows($results) == 1) {
            ...
            array_push($errors, "የማያገለግል ምስጢር ቃል መይም የተጠቃሚ ስም!");
        }	 
