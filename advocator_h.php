...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="Silver"><td colspan="8"><table width="100%" height="5%" id="navigation">
	 <td width="161"><a href="PADMIN.php" target="myframe"class="navText style2"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-home"></i></br>Home</button></a></td>
	 	 <td width="161"><a href="casetoadvocator.php" target="myframe"class="navText style2"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-users"></i></br>Customer</button></a></td>
	 <td width="184"  > <a href="viewdecisiond.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-legal"></i></br>View decision</button></a></td>
      ...
      <td width="152" ><a href="appointment2.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-book"></i></br>Appointment</button></a></td>
  ...
  <tr><td width="230" height="200" valign="top" bgcolor="Silver"><table width="230" border="0" cellpadding="0" cellspacing="0" id="navigation">
        <tr>
        <td width="158" id="dateformat" style="background-color:Silver">&nbsp;&nbsp;
    <script language="JavaScript" type="text/javascript">
      document.write(TODAY);	</script>    <?php if (isset($_SESSION['success'])) : ?>
...
if($row1['fname']==$_SESSION['user_name']){		
		?>
<center>
<p>
<?php echo "<div style='font-size:15px;font-weight:bold;color:blue'>".$row1['fname']."&nbsp;".$row1['mname']; ?>
           <br>
			
	<?php echo "<div style='font-size:15px;font-weight:bold;color:blue'>".$row1['status'];}}} ?>
	</div>
        ...
        <?php endif ?>
	     ...
	     <tr>
          <td width="230" align="center"><a href="searchjudge.php" target="myframe" class="navText  style11"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Find jugge</button></a></td>
        </tr>
		<td width="225" align="center"><a href="help.php" target="myframe" class="navText  style11"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Help</button></a></td>
        </tr>
       </table>
 </td>
