...
require_once 'dbConfig.php';
 if($date>date('Y/m/d')){
	 echo '<script type="text/javascript">alert("የተሳሳተ ቀን.");window.location=\'1advocator_registration.php\';</script>'; 
 }
 else{
...
if($sql){
 echo '<script type="text/javascript">alert(" ተመዝግቧል!!");window.location=\'1advocator_registration.php\';</script>';
}
if(!$retval ) { 
