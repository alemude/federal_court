<center><p style="font-size:30px;font-weight:bold;color:green;align:center">የባህር ዳር ዙሪያ ወረዳ ፍ/ቤት ሪፖርት</p></center>
<p style="font-size:20px;font-weight:bold;color:blue;align:center">ወራዊ ሪፖርት</p>
<?php
...
echo '<table width="100%" height="15%" cellspacing="0" cellpadding="0" border="1">
   ...
   <tr style="background-color:Silver;border-color:green">
	...
	?>
	<p style="font-size:20px;font-weight:bold;color:blue;align:center">መንፈቃዊ ሪፖርት</p>
<?php
require_once 'dbConfiga.php';
$count=0;
$count1=0;
...
echo '<table width="100%" height="15%" cellspacing="0" cellpadding="0" border="1">
   ...
   <tr style="background-color:Silver;border-color:green">
	...
	?>
	<p style="font-size:20px;font-weight:bold;color:blue;align:center">አመታዊ ሪፖርት</p>
<?php
require_once 'dbConfiga.php';
$count=0;
$count1=0;
