...
echo $B;
if(!$id_present){
 echo '<script type="text/javascript">alert(" You entered unknown case ID!!");window.location=\'cusAdvo.php\';</script>';	
}
else if(!$judge_present){
 echo '<script type="text/javascript">alert(" You entered unknown advocator ID!!");window.location=\'cusAdvo.php\';</script>';	
}
else{	
  ...
  if ($result2) {
           echo '<script type="text/javascript">alert(" Register successfully!!");window.location=\'cusAdvo.php\';</script>';
}
}}
}						
}
