	...
	<body>
<form>
 <input style="width:7%;height:7%; background-color:blue;border-radius:5px;color:white;font-weight:bold;font-size:20px" type="button" value="መመለስ " onclick="history.go(-1)">
</form>	
<?php 
$count=0;
...
$sqs= "SELECT  * FROM createaccount";
 ...
 $sqsa= "SELECT  * FROM assignedcases where judgeID='$m'";
	...
	echo 
	  ...
	  <p style='font-size:20px;background-color:Silver;color:black;font-weight:bold' >ሙሉ ስም :".$row1['first_name']."&nbsp;&nbsp;".
	  $row1['last_name']."<br>የዳኛው አይነት :".$row1['status']."<br>Employee ID is:&nbsp;".$row1['id']."<br></P></td><td>
	  
	  <a href='1assignedcase.php'>
	  
	  <form action='1assign.php' method='post'>
	  ...
	  </a></td><td><div style='color:red;font-size:20px'>".$k."</div><i style='color:blue;font-size:25px'class='fa-solid fa-shopping-cart'></i><br>የተከፈተ ፋይል</td></tr></table>";
