...
echo "<table border='0' style='box-shadow:rgba(0,0,0,1) 0px 0px 10px;width:35%;height:5%; background-color:Silver;border-radius:10px;color:black;'><tr><td><td>"."<form style='box-shadow:rgba(0,0,0,1) 0px 0px 10px; border-radius:40px;color:#jjlldd; text-shadow:1px 0px 10px #99ccff;'>"."<b style= 'font-size:20px'>"."ከአስተዳደር :";
          ...
          "  <p style='color:black'>"."
		   ...
		   <b style= 'font-size:25px;'><br><p style='color:blue'> በ:</p>".$row['created']."<br></details>"."
