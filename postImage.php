...
<body>
<form>
 <input style="width:7%;height:5%; background-color:blue;border-radius:5px;color:white;font-weight:bold;font-size:15px" type="button" value="Back!" onclick="history.go(-1)">
</form>
<form action="postImage.php" method="post" enctype="multipart/form-data" style="box-shadow:rgba(0,0,0,1) 0px 0px 10px;width:40%;height:55%; background-color:Silver;border-radius:10px;color:black;font-weight:bold">
...
Chose image what you want to post</p>
