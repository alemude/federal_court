...
<body>
<form action="viewcasecioa.php" method="post">
<h2>በቀላሉ ለማግኘት መለዮውን ያስገቡ</h2>
...
if($value<10){
	echo "<table border='0' style='box-shadow:rgba(0,0,0,1) 0px 0px 10px;width:75%;height:5%; background-color:#F5FFFA;border-radius:10px;color:black;'><tr><td><td>"."<form style='box-shadow:rgba(0,0,0,1) 0px 0px 10px; border-radius:10px;color:#jjlldd; text-shadow:1px 0px 10px #99ccff;'>"."<b style= 'font-size:20px'>"."የፋይል መለዮ:&nbsp;".$row1['caseID']."</b>";
	 ...
	 <br>"."<p style='color:blue'> የከሳሽ መለዮ:</p>".$row1['accuserID']."
 ...
 <br>"."<p style='color:blue'> የተከሳሽ ስም:</p>".$row1['name1']."&nbsp&nbsp".$row1['fname1']."
  ...
  <br>"."<p style='color:blue'>የችሎት ቁጥር:</p>".$row1['chilot']."
      ...
      <br>"."<p style='color:blue'>የከሳሽ ጠበቃ መለዮ:</p>".$row1['accuser_advo_ID'].""."
...
echo "
<form action='1assigncasea.php' method='post'>
<input type='submit' value='ሰይም' style='height:40px;font-weight:bold;width:60px;border-radius:10px;background-color:green;border-color:red;color:white'/>
</td><td><p style='color:green;font-size:20px;font-weight:bold'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;መደበኛ($value&nbsp;ቀን)</p></td></tr><table>";
}
...
echo "
<form action='1assigncasea.php' method='post'>
<input type='submit' value='ሰይም' style='height:40px;font-weight:bold;width:60px;border-radius:10px;background-color:yellow;border-color:red;color:black'/>
...
echo "
<form action='1assigncasea.php' method='post'>
<input type='submit' value='ሰይም' style='height:40px;font-weight:bold;width:60px;border-radius:10px;background-color:red;border-color:red;color:white'/>
