...
if($caseID!=$A){
 echo '<script type="text/javascript">alert(" You entered unknown case ID!!");window.location=\'appoint.php\';</script>';	
}
else if($judgeID!=$B){
 echo '<script type="text/javascript">alert(" You entered unknown judge ID!!");window.location=\'appoint.php\';</script>';	
}
else if($date<date('Y/m/d')){
 echo '<script type="text/javascript">alert("Wrong date,past date!!");window.location=\'appoint.php\';</script>';	
}
else{
require_once 'dbconfig.php'; 
