   ...
   <tr bgcolor="Silver"><td colspan="8"><table width="100%" height="5%" id="navigation">
	  <td width="161"><a href="PADMIN.php" target="myframe"class="navText style2"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-home"></i></br>Home</button></a></td>
       <td width="184"  ><a href="displayInfo.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-share"></i></br>View Post</button></a></td>
        <td width="184"  ><a href="viewevidence.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-assistive-listening-systems"></i></br>View evidence</button></a></td>
	 <td width="184"  ><a href="decision1.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-legal"></i></br>View decision</button></a></td>
          <td width="161"><a href="advocatord.php" target="myframe"class="navText style2"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-user-graduate"></i></br>Advocator</button></a></td>
       
	<td width="152" ><a href="appointment3.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-book"></i></br>Appointment</button></a></td>
...
<div onClick="JavaScript:newWindow('rec_decision.php')"> <button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Record decision</button></div>
</td>
        </tr>
	  			         <tr><td width="230" align="center">
 <a href="appoint.php" target="myframe" class="navText"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Give appointment</button></a>
		        </tr>
    			         <tr><td width="230" align="center">
 <a href="caseassigned1.php" target="myframe" class="navText"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Assigned cases</button></a>
		        </tr>
    			         <tr><td width="230" align="center">
 <a href="2search.php" target="myframe" class="navText"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Search customer</button></a>
		        </tr>
		  <tr>
...
<div onClick="JavaScript:newWindow('evidence.php')" <button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Record evidence</button></div>
		  
		  
		  </td>
        </tr>
			         <tr><td width="230" align="center">
 <a href="updatePassword.php" target="myframe" class="navText"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">Change password</button></a>
		        </tr>
