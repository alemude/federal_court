...
<body>
<form action="searchjudgea.php" method="post" style="box-shadow:rgba(0,0,0,1) 0px 0px 10px;width:60%;height:60%; background-color:Silver;border-radius:10px;color:black;font-weight:bold">
...
If($search==$row1['id']){
	$k=1;
	echo "<table border='0' style='box-shadow:rgba(0,0,0,1) 0px 0px 10px;width:85%;height:5%; background-color:pink;border-radius:10px;color:black;'><tr><td><td>"."<form style='box-shadow:rgba(0,0,0,1) 0px 0px 10px; border-radius:40px;color:#jjlldd; text-shadow:1px 0px 10px #99ccff;'>"."<b style= 'font-size:20px'>"."የዳኛውን መለዮ:&nbsp;".$row1['id']."</b>";
			echo " <article>"."  <details>".
          "  <summary>"."<b style= 'font-size:20px;'>"."ሁሉን እይ..."."</b>"."</summary>".
          "  <p style='color:black'>"."
			<b style= 'font-size:25px;'>"
			."<p style='color:blue'>ቀን:</p>".$row1['date']."
	 <br>"."<p style='color:blue'> ስም:</p>".$row1['first_name']."&nbsp;&nbsp;".$row1['last_name']."
	 	 <br>"." <p style='color:blue'> የስራ መደብ:</p>".$row1['status']."
	 <br>"." <p style='color:blue'> እድሜ:</p>".$row1['age']."
	 <br>"." <p style='color:blue'> ጾታ:</p>".$row1['sex']."
	 <br>"."<p style='color:blue'> ኢሜል:</p>".$row1['email']."
