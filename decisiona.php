...
if($A!=$caseID){
 echo '<script type="text/javascript">alert(" የማይታወቅ  የፋይል መለዮ  ነው  ያስገቡ!!");window.location=\'rec_decision.php\';</script>';	
}
else if($date>date('Y/m/d')){
 echo '<script type="text/javascript">alert("የተሳሳተ ቀን!!");window.location=\'rec_decision.php\';</script>';	
}
else if($caseID==$A){
...
if ($db->query($query) === TRUE) { 
 echo '<script type="text/javascript">alert("ተሳክቷል ");window.location=\'rec_decision.php\';</script>';
		}}
