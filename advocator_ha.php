  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="Silver"><td colspan="8"><table width="100%" height="5%" id="navigation">
	 <td width="161"><a href="PADMINa.php" target="myframe"class="navText style2"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-home"></i></br>መግቢያ ገጽ</button></a></td>
	 	 <td width="161"><a href="casetoadvocatora.php" target="myframe"class="navText style2"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-users"></i></br>ደንበኞች</button></a></td>
	 <td width="184"  > <a href="viewdecisionda.php" target="myframe"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold"><i style="color:blue;font-size:25px"class="fa-solid fa-legal"></i></br>ዉሳኔ ማየት</button></a></td>
...
<?php echo "<div style='font-size:15px;font-weight:bold;color:blue'>".$row1['fname']."&nbsp;".$row1['mname']; ?>
	...
	<?php echo "<div style='font-size:15px;font-weight:bold;color:blue'>".$row1['status'];}}} ?>
        ...
        <?php endif ?>
	     ...
	     <tr>
          <td width="230" align="center"><a href="searchjudgea.php" target="myframe" class="navText  style11"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">ዳኛ መፈለግ</button></a></td>
        </tr>
		<td width="225" align="center"><a href="helpa.php" target="myframe" class="navText  style11"><button style="box-shadow:rgba(0,0,0,1) 0px 0px 20px;width:100%; height:100%;background-color:white;border-radius:5px;color:black;font-size:20px;font-weight:bold">እርዳታ</button></a></td>
        </tr>
       </table>
 </td>
...
<iframe  src="PADMINa.php" name="myframe" frameborder="1" height="440" width="100%"></iframe>  </tr>
      ...
      መብቱ በህግ የተረጋገጠ ነው! @ 2014 ዓ.ም  የፍርድ ቤት አያያዝ ሲስተም
            </marquee>
          </span> </td>
  </tr>
</table>
