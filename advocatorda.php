...
<body>
<form action="advocatorda.php" method="post">
<h2>የሚፈልጉትን ጠበቃ ለመፈለግ  ከጠበቃው የሚያስታውሱትን ያስገቡ</h2>
...
echo " <article><details><summary>"."<b style= 'font-size:20px;'>".$row1['fname'].'&nbsp;&nbsp;'.$row1['mname'].'&nbsp;&nbsp;'.$row1['lname']."</p><b style= 'font-size:20px;'>ለበለጠ መረጃ...</b></summary>
 <br>"." <p style='color:blue'>መለያ ቁጥር:</p>"."<b style= 'font-size:20px;'>".$row1['advo_ID']."</b>
	 <br>"." <p style='color:blue'>እድሜ:</p>"."<b style= 'font-size:20px;'>".$row1['age']."</b>
	 <br>"." <p style='color:blue'>ፆታ:</p>"."<b style= 'font-size:20px;'>".$row1['sex']."</b>
	 <br>"."<p style='color:blue'> ኢሜይል:</p>"."<b style= 'font-size:20px;'>".$row1['email']."</b>
	 <br>"." <p style='color:blue'>ወረዳ:</p>"."<b style= 'font-size:20px;'>".$row1['woreda']."</b>
	 <br>"." <p style='color:blue'>ከተማ:</p>"."<b style= 'font-size:20px;'>".$row1['city']."</b>
	  <br>"."<p style='color:blue'>ስልክ ቁጥር:</p>"."<b style= 'font-size:20px;'>".$row1['phone']."</b>
	  <br>"."<p style='color:blue'>ማዕረግ:</p>"."<b style= 'font-size:20px;'>".$row1['status']."</b>
	  <br>"."<p style='color:blue'>ስለ ጠበቃው:</p>"."<b style= 'font-size:20px;'>".$row1['description']."</b>
</details>"."
</article>"."
</td>
</tr>
